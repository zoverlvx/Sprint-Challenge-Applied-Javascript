...
class TabCard {
  ...
  static addCard(card) {
    ...
    newCard.setAttribute("data-tab", card.subject);
    const headline = document.createElement("div");
    headline.classList.add("headline");
    headline.innerText = card.headline;
...
cardsContainer.appendChild(TabCard.addCard({author: "Zach", subject: "javascript", headline: "JSLint"}));
